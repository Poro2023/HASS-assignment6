...
.append("tspan")
		...
		con1.append("tspan")
			...
			.attr('dy', '1.2em')
			.style('font-weight', "bold")
			.text("concerns are highly correlated with the intention to build a home garden")
		...
		con1.append("tspan")
			.attr('x', 0)
			.attr('dy', '1.2em')
			.text("with a Pearson Correlation Coefficient greater than 0.5. . This analysis ")
		con1.append("tspan")
			.attr('x', 0)
			.attr('dy', '1.2em')
			.text("also verifies the 4 hypotheses we have formulated.")
...
.append("tspan")
		...
		con2.append("tspan")
			...
			.attr('dy', '1.2em')
			.style('font-weight', "bold")
			.text("have a higher intention to build a home garden than Shanghai residents. ")
		...
		con3.append("tspan")
			...
			.attr('dy', '1.2em')
			.style('font-weight', "normal")
			.text("(Multicollinearity was not a significant issue, as the Pearson Correlation Coefficient)")
		con3.append("tspan")
			.attr('x', 0)
			.attr('dy', '1.2em')
			.text("was small.")
